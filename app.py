...
FALLBACK_PRIMARY = "OneThousand_QandA_Jsub.csv.utf8.csv"
...
def _selection_fingerprint():
    return {
        ...
        "random_n": st.session_state.get("random_n"),
...
mode = st.sidebar.radio(
    ...
    index=[
        ...
        "Calculation only",
        "Non-calculation only",
    ].index(st.session_state.get("mode", "All")),
    key="mode",
)
if mode == "Range":
...
active_mode = st.session_state.get("mode", "All")
